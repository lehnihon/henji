		...
		<div class="site-content">
			...
			<div class="row">
				...
				<div class="col grid_2_of_12">
					<a href="#"><img class="efeito-cinza" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/modulo1.png"; ?>"/></a>
				...
				<div  class="col grid_2_of_12">
					<a href="#"><img class="efeito-cinza" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/modulo2.png"; ?>"/></a>
					<h5>Módulo Frota</h5>
					<p>
				...
				<div class="col grid_2_of_12">
					<a href="#"><img class="efeito-cinza" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/modulo3.png"; ?>"/></a>
				...
				<div class="col grid_2_of_12">
					<a href="#"><img class="efeito-cinza" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/modulo4.png"; ?>"/></a>
				...
				<div class="col grid_2_of_12">
					<a href="#"><img class="efeito-cinza" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/modulo5.png"; ?>"/></a>
